...
double setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Circle::Circle(const char* const token[]):radius(setMeasurement(token[1])) {} // constructor definition with variable assigned
double Circle::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Cube::Cube(const char* const token[]):side(setMeasurement(token[1])) {}
double Cube::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Cylinder::Cylinder(const char* const token[]):radius(setMeasurement(token[1])), height(setMeasurement(token[2])) {} // constructor definition
double Cylinder::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Prism::Prism(const char* const token[]):length(setMeasurement(token[1])), width(setMeasurement(token[2])), height(setMeasurement(token[3])) {} // constructor definition
double Prism::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Rectangle::Rectangle(const char* const token[]): length(setMeasurement(token[1])), width(setMeasurement(token[2])) {}// constructor declaration
double Rectangle::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
// class definitions:
Square::Square(const char* const token[]):side(setMeasurement(token[1])) {}
double Square::setMeasurement(const char* const m) {return m?atof(m):0;} // end setMeasurement
...
int main()
{
  ...
  cout << "Description: modify GeometryHomework3 to make\n";
  cout << "'const' all data member declarations, getters, \n";
  cout << "local variables, and function parameter variables.\n";
  cout << "-------------------------------\n\n";
